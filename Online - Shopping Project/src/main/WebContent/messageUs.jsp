...
<body>
<div style="color: Orange; text-align: center; font-size: 30px;">Message Us <i class='fas fa-comment-alt'></i></div>
<%
String msg=request.getParameter("msg");
if("valid".equals(msg))
{
%>
<h3 style="text-align:center; color:Blue;">Message successfully sent. Our team will get to you soon!</h3>
<%} %>
<%
if("invalid".equals(msg))
{
%>
<h3 style="text-align:center; color:blue;">Something Went Wrong! Try Again!</h3>
<%} %>
